...
function clearResults() {
  ...
  // NATH: I would have used a forEach here as it is a bit easier to read
...
function openModal(event) {
  ...
  const restaurantContent = restaurantCard
        ...
        .cloneNode(true);
  // NATH: if this is a global querySelector it would be better at the top for re-usability
...
// NATH
// factor out the apiKey into a variable to enable easy change of apiKey later
// I like how you have already made a verbose function name for
// creating the restaurant nodes.

// but there is still a lot of repetition of code in the next 3 eventListener's

// when you see repetition like this in your code that is the
// signal that you could probably write a more general function as
// a callback for each eventListener
// research DRY principle for more examples
...
function createRestaurantsNodes(restaurants) {
  ...
  restaurants.map(({ restaurant }) => {
    ...
    // NATH
    // creating a function to describe what this part of the code
    // is doing is good. But if you have a million restaurants
    // then you will be creating a new function for each
    // restaurant in the restaurants list.

    // Even better would be to define this function outside of
    // createRestaurantsNodes function and refactor it to take
    // everything else that it needs as a arguments of setMarkers
    // function
...
filterBy.addEventListener("click", () => {
  ...
  // NATH you also have a clearResults function at the top of the file.
...
weatherBtn.addEventListener("click", event => {
  ...
  fetch(
    ...
    .then(response => {
      ...
      // NATH these selector's feel global to me
